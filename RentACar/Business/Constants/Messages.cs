   ...
   public static class Messages
    {
        ...
        internal static string CarImageNotAdded = "Bir arabanın en fazla 5 resmi olabilir";
        internal static string CarImageAdded = "Araba eklendi";
        internal static string CarImageNotFound = "Araba resmi bulunamadı";
        internal static string CarImageDeleted = "Araba resmi silindi";
        internal static string CarImageUpdated = "Araba resmi güncellendi";
        internal static string CarImageLimitExceeded = "Bir arabanın en fazla 5 resmi olabilir";
        internal static string AuthorizationDenied = "Yetkiniz yok";
        internal static string UsersListed = "Kullanıcılar listelendi";
        internal static string CarImageListed = "resimler listelendi";
        internal static string CardDeleted = "Kredi Kartı silindi";
